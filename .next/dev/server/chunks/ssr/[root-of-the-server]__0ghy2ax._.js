...
function NotesClient({ tag }) {
    ...
    const { data = {
        notes: [],
        totalPages: 0
    }, isLoading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "notes",
            tag,
            page,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0ghy2ax._.js.map